            ...
            <div className="max-w-5xl mx-auto px-4 mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                            ...
                            <div className="space-y-3 w-full text-center sm:text-left">
                                ...
                                <div className="pt-3 border-t border-slate-100 text-xs text-slate-500">
                                    <p className="flex items-center justify-center sm:justify-start gap-2">
                                        <span className="text-slate-400 font-medium uppercase tracking-wider">Founder Name:</span>
                                        <span className="text-slate-700 font-medium">{startup.founderName}</span>
                                    </p>
                                    <p className="flex items-center justify-center sm:justify-start gap-2">
                                        <span className="text-slate-400 font-medium uppercase tracking-wider">Founder Email:</span>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white border border-slate-200/70 rounded-2xl p-6 shadow-sm relative overflow-hidden">
                        ...
                        <div className={`absolute top-0 left-0 right-0 h-0.75 ${accentBarColor}`} />
